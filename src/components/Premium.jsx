...
const Premium = () => {
  ...
  const handleBuyClick = async (type) => {
    try {
      ...
      if (!window.Razorpay) {
        alert("Razorpay SDK failed to load. Please check your index.html script tag.");
        return;
      }
    ...
    <div className="w-full min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="flex flex-col md:flex-row gap-8 max-w-5xl w-full">
        ...
        <div className="card bg-white shadow-xl rounded-2xl p-8 flex-1 border border-gray-200">
          ...
          <p className="text-center text-gray-500 mb-6">Perfect for getting started</p>
        ...
        <div className="card bg-gradient-to-br from-indigo-600 to-purple-600 shadow-2xl rounded-2xl p-8 flex-1 text-white relative">
          <span className="absolute top-4 right-4 badge badge-warning text-black">Popular</span>
          <h1 className="text-2xl font-bold text-center mb-4">Gold Membership</h1>
          <p className="text-center text-indigo-100 mb-6">Best value for power users</p>
